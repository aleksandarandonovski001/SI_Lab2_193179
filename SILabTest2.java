...
public class SILab2Test {
    ...
    public void everyBranch(){
        ...
        //2
        assertEquals(9650, SILab2.function(createList(2,35,55)));

        //3
        ex=assertThrows(RuntimeException.class, () -> SILab2.function(createList(27,25,10)));
        assertTrue(ex.getMessage().contains("The hours are greater than the maximum"));

        //4
        ex=assertThrows(RuntimeException.class, () -> SILab2.function(createList(-2,15,20)));
        assertTrue(ex.getMessage().contains("The hours are smaller than the minimum"));

        //5
        ex=assertThrows(RuntimeException.class, () -> SILab2.function(createList(18,10,75)));
        assertTrue(ex.getMessage().contains("The minutes are greater than the maximum"));

        //7
        ex=assertThrows(RuntimeException.class, () -> SILab2.function(createList(18,70,35)));
        assertTrue(ex.getMessage().contains("The seconds are not valid"));

        //8
        ex=assertThrows(RuntimeException.class, () -> SILab2.function(createList(24,20,22)));
